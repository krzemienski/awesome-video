...
* [Apple Developer Documentation](https://developer.apple.com/documentation/http_live_streaming/example_playlists_for_http_live_streaming/live_playlist_sliding_window_construction)  - 
* [Apple Developer Documentation](https://developer.apple.com/documentation/http_live_streaming/understanding_the_http_live_streaming_architecture)  - 
...
* [HLS adaptive streaming tutorial with CloudFront &#038; JW Player](https://www.miracletutorials.com/hls-adaptive-streaming-tutorial-with-cloudfront-jw-player/)  - A step-by-step HLS adaptive streaming tutorial with CloudFront & JW Player in two parts. It is easier than you think. This tutorial presumes you have already an Amazon Web Services account (AWS) and a premium license of JW Player 6 or 7.
...
* [Live video transmuxing transcoding f fmpeg vs twitch transcoder part i 489c1c125f28](https://blog.twitch.tv/en/2017/10/10/live-video-transmuxing-transcoding-f-fmpeg-vs-twitch-transcoder-part-i-489c1c125f28/)  - 
* [Live video transmuxing transcoding ffmpeg vs twitchtranscoder part ii 4973f475f8a3](https://blog.twitch.tv/live-video-transmuxing-transcoding-ffmpeg-vs-twitchtranscoder-part-ii-4973f475f8a3?source=userActivityShare-94bccb50d11-1561003748&_branch_match_id=670105191114382351&gi=fd8d504494f4)  - 
...
* [Pyrmont Brewery](https://docs.google.com/presentation/d/15560aTv054w6bXKQ9gmBCE8gYwgtXhaPOHS1JcqTofk/edit?usp=sharing)  - Brewing in Pyrmont and Eora country Prepared for The Pyrmont History Group Kev Staunton-Lambert pyrmontbrewery.com
...
* [WebAssembly (Wasm)](https://docs.google.com/presentation/d/1sonEk2neNVBcy8EzieUjWCNzj5SXN7dk-unkR_lpl8k/edit?usp=sharing)  - Wasm) WebAssembly Wasm On the Edge Prepared for syd meet-up Kev Staunton-Lambert pyrmontbrewery.com
...
* [bash scripts to create VOD HLS stream with ffmpeg almighty (tested on Linux and OS X)](https://gist.github.com/mrbar42/ae111731906f958b396f30906004b3fa)  - bash scripts to create VOD HLS stream with ffmpeg almighty (tested on Linux and OS X) · GitHub
...
* [Introduction to Digital Audio Coding and Standards (The Springer International Series in Engineering and Computer Science)](https://www.amazon.com/dp/1402073577/ref=cm_sw_r_oth_api_i_YIz-DbVR4VXKS)  - 
* [Ref=ppx yo dt b asin title o01 s00](https://www.amazon.com/gp/product/3662442752/ref=ppx_yo_dt_b_asin_title_o01_s00?ie=UTF8&psc=1)  - 
* [Ref=ppx yo dt b search asin title](https://www.amazon.com/gp/product/3319068946/ref=ppx_yo_dt_b_search_asin_title?ie=UTF8&psc=1)  - 
* [Ref=ppx yo dt b search asin title](https://www.amazon.com/gp/product/0976259540/ref=ppx_yo_dt_b_search_asin_title?ie=UTF8&psc=1)  - 
* [Ref=sr 1 1](https://www.amazon.com/MPEG-4-Book-Fernando-Pereira/dp/0130616214/ref=sr_1_1?keywords=mpeg+4+book&qid=1576252504&s=books&sr=1-1)  - 
* [The MPEG Handbook, Second Edition](https://www.amazon.com/dp/024080578X/ref=cm_sw_r_oth_api_i_oTz-Db86M94H9)  - 
* [Transporting Compressed Digital Video (The Springer International Series in Engineering and Computer Science)](https://www.amazon.com/dp/140207011X/ref=cm_sw_r_oth_api_i_DLz-DbTTZS7FP)  - 
...
* [Demuxed](https://www.heavybit.com/library/podcasts/demuxed)  - Demuxed is a podcast made for and by engineers working with video. Brought to you by Heavybit.
* [Demuxed 2019](https://m.youtube.com/playlist?list=PLkyaYNWEKcOf_C_6W45abNvXMb40xUUqh)  - 
* [Episodes](https://thevideoinsiders.simplecast.com/episodes)  - 
...
* [507 hls authoring for airplay 2 video](https://devstreaming-cdn.apple.com/videos/wwdc/2019/507fk9wyls0np6piwk/507/507_hls_authoring_for_airplay_2_video.pdf)  - 
* [510 validating http live streams](https://devstreaming-cdn.apple.com/videos/wwdc/2016/510ndmh9wkcvzneegv2/510/510_validating_http_live_streams.pdf)  - 
* [Apple Developer Documentation](https://developer.apple.com/documentation/avfoundation/airplay_2/integrating_airplay_for_long-form_video_apps)  - 
* [Apple Developer Documentation](https://developer.apple.com/documentation/http_live_streaming/protocol_extension_for_low-latency_hls_preliminary_specification#3291001)  - 
...
* [HLS](https://www.bento4.com/developers/hls/)  - 
...
* [Introducing Low-Latency HLS - WWDC 2019 - Videos](https://developer.apple.com/videos/play/wwdc2019/502)  - Since its introduction in 2009, HTTP Live Streaming (HLS) has enabled the delivery of countless live and on‐demand audio and video...
...
* [globocom/m3u8](https://github.com/globocom/m3u8)  - Python m3u8 Parser for HTTP Live Streaming (HLS) Transmissions - globocom/m3u8
...
* [puemos/hls-downloader-web-extension](https://github.com/puemos/hls-downloader-chrome-extension)  - Web Extension for sniffing and downloading HTTP Live streams (HLS) - puemos/hls-downloader-web-extension
...
* [Dash if iop v4](https://dashif.org/docs/DASH-IF-IOP-v4.3.pdf)  - 
...
* [Dash-Industry-Forum/ISOSegmentValidator](https://github.com/Dash-Industry-Forum/ISOSegmentValidator)  - 
...
* [videojs/mpd-parser](https://github.com/videojs/mpd-parser)  - 
...
* [Projects · olaris / olaris-server](https://gitlab.com/olaris/olaris-server)  - GitLab.com
...
* [07254155](https://ieeexplore.ieee.org/ielx7/76/7372356/07254155.pdf?tp=&arnumber=7254155&isnumber=7372356&ref=)  - 
* [515 hls authoring update](https://devstreaming-cdn.apple.com/videos/wwdc/2017/515vy4sl7iu70/515/515_hls_authoring_update.pdf)  - 
...
* [Encoding for hevc sme 2018 jan](https://streaminglearningcenter.com/wp-content/uploads/2018/05/Encoding-for-HEVC-SME-2018-Jan.pdf)  - 
...
* [ossrs/srs](https://github.com/ossrs/srs)  - SRS is a RTMP/HLS/WebRTC/SRT/GB28181 streaming cluster, high efficiency, stable and simple. - ossrs/srs
...
* [Quantifying packaging overhead | Mux blog](https://mux.com/blog/quantifying-packaging-overhead-2)  - Mux makes adding video to your app or website as easy as making a single API call. But behind the scenes is a large multistep process to analyze and transform the video into something that can be eas ...
...
* [Video Coding](https://www.bbc.co.uk/rd/projects/video-coding)  - Delivering a large amount of video data with limited bandwidth and high perceived quality.
...
* [Video on demand on aws](https://s3.amazonaws.com/solutions-reference/video-on-demand-on-aws/latest/video-on-demand-on-aws.pdf)  - 

## Specs and Standards
*Latest offical specs and standards related to video streaming.*

* [DASH Industry Forum | Catalyzing the adoption of MPEG-DASH](https://dashif.org/guidelines/)  - 
* [HTTP Live Streaming 2nd Edition](https://tools.ietf.org/html/draft-pantos-hls-rfc8216bis-05)  - 
...
* [Discover MPEG](https://mpeg.chiariglione.org/about)  - Gateway to a lot of MPEG documents
* [Meetings | MPEG](https://mpeg.chiariglione.org/meetings)  - Get information on all MPEG meetings, logistics, press releases, public documents etc.
...
* [Ios avplayer http capture](https://github.com/masterjk/ios-avplayer-http-capture)  - 
...
* [rokudev/automated-channel-testing](https://github.com/rokudev/automated-channel-testing)  - Roku Automated Channel Testing: Selenium-based WebDriver + Robot Framework + JS Framework + Samples - rokudev/automated-channel-testing
...
* [Ch00k/ffmpy](https://github.com/Ch00k/ffmpy)  - Pythonic interface for FFmpeg/FFprobe command line - Ch00k/ffmpy
...
* [compile and install latest ffmpeg source as pkg](https://gist.github.com/krzemienski/e51a0b7a6ba77e616f954e516783270c#file-compile-and-install-latest-ffmpeg-source-sh-L2)  - compile and install latest ffmpeg source as pkg · GitHub
...
* [kkroening/ffmpeg-python](https://github.com/kkroening/ffmpeg-python)  - Python bindings for FFmpeg - with complex filtering support - kkroening/ffmpeg-python
...
* [microshow/RxFFmpeg](https://github.com/microshow/RxFFmpeg)  - 🔥RxFFmpeg 是基于 ( FFmpeg 4.0 + X264 + mp3lame + fdk-aac ) 编译的适用于 Android 平台的音视频编辑、视频剪辑的快速处理框架，包含以下功能：视频拼接，转码，压缩，裁剪，片头片尾，分离音视频，变速，添加静态贴纸和gif动态贴纸，添加字幕，添加滤镜，添加背景音乐，加速减速视频，倒放音视频，音频裁剪，变声，混音，图片合成视频，视频解码图片，...
...
* [x264 FFmpeg Options Guide - Linux Encoding](https://sites.google.com/site/linuxencoding/x264-ffmpeg-mapping)  - null

## Audio
*Audio libraries, tools, and examples.*

* [Adjust and Normalize Your Music Files with FFMPEG](https://www.maketecheasier.com/normalize-music-files-with-ffmpeg/)  - If your music files are too loud, too soft, or have obnoxious peaks and irregular volume, you can use FFmpeg to normalize your music files. Here's how.
* [Audio Loudness | Conversational Actions](https://developers.google.com/assistant/tools/audio-loudness)  - 
* [Audio normalization with ffmpeg using loudnorm (ebur128) filter](https://bytesandbones.wordpress.com/2017/03/16/audio-nomalization-with-ffmpeg-using-loudnorm-ebur128-filter/)  - Source: Source: (Credits: k@ylo.ph | Source discovered by Mulvya) ./ffmpeg -i /path/to/input.wav -af loudnorm=I=-16:TP=-1.5:LRA=11:print_format=summary -f null – This instructs FFmpeg to me…
...
* [How To Normalize Audio - Why Do It? Everything You Need To Know](https://www.learndigitalaudio.com/normalize-audio)  - Why would you want to normalize audio? Find out EXACTLY what it does and avoid the HIDDEN DANGERS. Learn about Peak, RMS and the benefits of EBU R-128
...
* [Tech3324](https://tech.ebu.ch/docs/tech/tech3324.pdf)  - 
* [Techniques for establishing and maintaining audio loudness](https://www.atsc.org/wp-content/uploads/2015/03/Techniques-for-establishing-and-maintaining-audio-loudness.pdf)  - 
* [Viewtopic](https://forum.audacityteam.org/viewtopic.php?t=63067)  - 
...
* [tcelectronic Loudness Explained](https://www.tcelectronic.com/brand/tcelectronic/loudness-explained#googtrans(en|en))  - 
...
* [Closed Captioning & Everything You Need to Know About It](https://www.3playmedia.com/resources/popular-topics/closed-captioning/)  - Whether you already caption, aren't sure if you need to caption, or are completely new to closed captioning, you'll find something to learn in this guide.
...
* [DVB-Sub Output Captions - MediaConvert](https://docs.aws.amazon.com/mediaconvert/latest/ug/dvb-sub-output-captions.html)  - ** If your output captions are DVB-Sub, set them up in your outputs according to the following information.
...
* [IMSC1 Renderer](https://sandflow.com/imsc1proc/index.html)  - 
* [IMSC1 Validator](https://apps.sandflow.com/imscV/)  - 
* [Manifesto](https://github.com/djstava/manifesto)  - 
* [TTML Profiles for Internet Media Subtitles and Captions 1.1](https://www.w3.org/TR/ttml-imsc1.1/)  - This specification defines two profiles of [ttml2]: a text-only profile and an image-only profile. These profiles are intended to be used across subtitle and caption delivery applications worldwide, thereby simplifying interoperability, consistent rendering and conversion to other subtitling and captioning formats.
...
* [fedecalendino/pysub-parser](https://github.com/federicocalendino/pysub-parser)  - Library for extracting text and timestamps from multiple subtitle files (.ass, .ssa, .srt, .sub, .txt). - fedecalendino/pysub-parser
* [glut23/webvtt-py](https://github.com/glut23/webvtt-py)  - Read, write and segment WebVTT caption files in Python. - glut23/webvtt-py
...
* [osk/node-webvtt](https://github.com/osk/node-webvtt)  - Parse WebVTT files, segments and generates HLS playlists for them - osk/node-webvtt
* [sandflow/imscJS](https://github.com/sandflow/imscJS/)  - JavaScript library for rendering IMSC Text and Image Profile documents to HTML5 - sandflow/imscJS
...
* [smacke/ffsubsync](https://github.com/smacke/subsync)  - Automagically synchronize subtitles with video. 自动同步字幕与视频。 - smacke/ffsubsync
...
* [subcheck.io](https://subcheck.io/#/)  - 
* [w3c/IMSC-1.0.1_Text_TestContent](https://github.com/w3c/IMSC-1.0.1_Text_TestContent/)  - 
* [w3c/IMSC-1.1_Image_TestContent](https://github.com/w3c/IMSC-1.1_Image_TestContent/)  - 
* [w3c/IMSC-1.1_Text_TestContent](https://github.com/w3c/IMSC-1.1_Text_TestContent/)  - 
* [wargarblgarbl/libgosubs](https://github.com/wargarblgarbl/libgosubs)  - golang library to read and write various subtitle formats - wargarblgarbl/libgosubs
...
* [AdEase - Advanced addressable advertising for live and on demand video](https://www.switch.tv/mediahq/adease/)  - AdEase provides an advanced video monetisation solution for addressable advertising across live and on demand apps. Visit us & monetise your videos.
* [Live2VOD - Effortlessly create VOD content from live and linear video](https://www.switch.tv/mediahq/live2vod/)  - Effortlessly create engaging video on demand content for your audience with Live2VOD for live and linear video in the cloud. Visit us and create VOD now!
* [MediaHQ - Powering effortless video across every screen](https://www.switch.tv/mediahq/)  - MediaHQ is a flexible suite of video management products and services powering world-class video experiences across connected devices
* [Universal Player - A highly optimised multi-platform video player](https://www.switch.tv/mediahq/universal-player/)  - The Universal Player is a highly versatile multi-platform video player for web, connected TV, gaming consoles and mobile devices. Click for more info
...
* [Dolby professional loudness solutions](https://www.dolby.com/us/en/technologies/dolby-professional-loudness-solutions.pdf)  - 
* [Dolby vision streams within the http live streaming format v2](https://www.dolby.com/us/en/technologies/dolby-vision/dolby-vision-streams-within-the-http-live-streaming-format-v2.0.pdf)  - 
* [Hybrik API Reference 2](https://docs.hybrik.com/api/v1/HybrikAPI.html?#getting-started)  - 
...
* [Aws stale playlist detector](https://github.com/awslabs/aws-stale-playlist-detector)  - 
...
* [Stream Analyzer - ts analyzer, stream validation, ETSI TR 101 290](https://www.elecard.com/products/video-analysis/stream-analyzer)  - Elecard Stream Analyzer is a professional tool for syntax analysis of encoded media streams New version 4.3 is released
...
* [gpac/gpac](https://github.com/gpac/gpac)  - Modular Multimedia framework for packaging, streaming and playing your favorite content. - gpac/gpac
...
* [mifi/lossless-cut](https://github.com/mifi/lossless-cut)  - The swiss army knife of lossless video/audio editing - mifi/lossless-cut
* [minio/minio](https://github.com/minio/minio)  - High Performance, Kubernetes Native Object Storage - minio/minio
...
* [slhck/ffmpeg-quality-metrics](https://github.com/slhck/ffmpeg-quality-metrics)  - Calculate quality metrics with FFmpeg (SSIM, PSNR, VMAF) - slhck/ffmpeg-quality-metrics
...
* [Digital Rights Management (DRM) - Everything you need to know](https://bitmovin.com/digital-rights-management-everything-to-know/)  - Content protection is key, but not everyone understands how to secure their content. Learn about Data Rights Management (DRM) to secure your video content!
...
* [HTTP Live Streaming 2nd Edition](https://tools.ietf.org/html/draft-pantos-hls-rfc8216bis-00#section-5.1)  - 
...
* [videojs/aes-decrypter](https://github.com/videojs/aes-decrypter)  - 

## Testing
*Video streaming testing tools and helpers.*

* [17 Free MPEG-DASH example and HLS m3u8 sample test streams](https://bitmovin.com/mpeg-dash-hls-examples-sample-streams/)  - MPEG-DASH example, HLS test streams and m3u8 streams. This is a list of free sample streams and data sets that you might find useful for development.
* [4K Media | Free Ultra-HD / HDR / HLG / Dolby Vision 4K Video Demos & Samples](https://4kmedia.org/)  - Uncompressed 4K demos,4K samples, and 4K trailers, to show off your new ultra-HD (2160p) HDR/HLG/Dolby Vision television or monitor.
...
* [115001609634 how to use dash and hls adaptive streaming with aws s3 and cloudfront](https://bitmovin.zendesk.com/hc/en-us/articles/115001609634-How-to-use-DASH-and-HLS-Adaptive-Streaming-with-AWS-S3-and-Cloudfront)  - 
* [Amazon S3 | Fastly Help Guides](https://docs.fastly.com/en/guides/amazon-s3)  - 
* [Delivering Live Streaming Video with CloudFront and AWS Media Services - Amazon CloudFront](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/live-streaming.html)  - To use AWS Media Services with CloudFront to deliver live content to a global audience, follow the guidance included in this section.
* [Edge Computing with Fastly CDN and Varnish VCL for Authenticated Requests](https://endertech.com/blog/edge-computing-fastly-cdn-varnish-vcl-authenticated-requests)  - A brief explanation of how to use Fastly CDN and Varnish with authenticated requests to offload static file serving from the origin and edge caching.
* [Fastly vs amazon cloudfront](https://www.cdnoverview.com/compare/fastly-vs-amazon-cloudfront/)  - 
...
* [Optimizing High Availability with CloudFront Origin Failover - Amazon CloudFront](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/high_availability_origin_failover.html)  - Learn how to increase the availability of your website, application, or content with Amazon CloudFront origin failover and other features.
* [Tutorial: Creating a Simple Lambda@Edge Function - Amazon CloudFront](https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/lambda-edge-how-it-works-tutorial.html)  - This tutorial shows you how to get started with Lambda@Edge by helping you create and add a sample Node.js function that runs in CloudFront. The example that we walk through adds HTTP security headers to a response, which can improve security and privacy for a website. You don’t need a website for this walkthrough. In it, we simply add security headers to a response when CloudFront retrieves a file.

## HDR10, HLG, Dolby Vision
*HDR tools, learning, documentations, and resources.*

* [Bbc hdrtv faq](https://downloads.bbc.co.uk/rd/pubs/papers/HDR/BBC_HDRTV_FAQ.pdf)  - 
* [Bbc hdrtv pq hlg transcode v2](https://downloads.bbc.co.uk/rd/pubs/papers/HDR/BBC_HDRTV_PQ_HLG_Transcode_v2.pdf)  - 
* [Bbc hdrtv use of lu ts f fmpeg](https://downloads.bbc.co.uk/rd/pubs/papers/HDR/BBC_HDRTV_Use_of_LUTs_FFmpeg.pdf)  - 
* [HLG vs PQ Systems for HDR Television](https://www.displaydaily.com/article/display-daily/hlg-vs-pq-systems-for-hdr-television)  - Meko Website
* [Hdr%20 smpte%20 presentation%20 march%2021,%202017%20 v2](https://www.smpte.org/sites/default/files/users/user27446/HDR%20SMPTE%20Presentation%20March%2021%2C%202017%20V2.compressed.pdf)  - 
* [High Dynamic Range Television and Hybrid Log-Gamma](https://www.bbc.co.uk/rd/projects/high-dynamic-range)  - Adding sparkle to television pictures
* [Media](https://developers.google.com/media/vp9/hdr-encoding)  - 
...
* [bbc/qtff-parameter-editor](https://github.com/bbc/qtff-parameter-editor)  - QuickTime file parameter editor for modifying transfer function, colour primary and matrix characteristics - bbc/qtff-parameter-editor
* [id3as/ffmpeg-libvpx-HDR-static](https://github.com/id3as/ffmpeg-libvpx-HDR-static)  - A script to build a static binary of FFmpeg optimised for libvpx (HDR 10bit) encoding. - id3as/ffmpeg-libvpx-HDR-static
