...
* [GeiserX/jellyfin-encoder](https://github.com/GeiserX/jellyfin-encoder)  - Docker-based automatic HEVC/AV1 transcoding service for Jellyfin libraries with NVIDIA and Intel hardware acceleration.
